    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="<?php echo e(route('user.tiktoks')); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('user.pricing')); ?>">
                        <i class="fas fa-chart-line"></i>
                        <span data-key="">Pricing</span>
                    </a>
                </li>
            ...
            <div class="card sidebar-alert shadow-none text-center mx-4 mb-0 mt-5">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo e(route('user.pricing')); ?>" class="upgrade-btn mt-2">Upgrade Now</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Left Sidebar End -->
<?php /**PATH C:\laragon\www\Kadava-New\resources\views/user/layouts/sidebar.blade.php ENDPATH**/ ?>